...
Revision ID: 92ce49e4c131
Revises: 33bc683404bd
Create Date: 2020-05-11 15:47:20.513769
...
revision = '92ce49e4c131'
down_revision = '33bc683404bd'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('cars', sa.Column('brh_name', sa.String(length=30), nullable=True))
    op.add_column('cars', sa.Column('proc_id', sa.String(length=20), nullable=True))
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('cars', 'proc_id')
    op.drop_column('cars', 'brh_name')
